...
bool StringTools_obj::isSpace( ::String s,int pos){
	HX_STACK_PUSH("StringTools::isSpace","StringTools.hx",162);
	HX_STACK_ARG(s,"s");
...
::String StringTools_obj::ltrim( ::String s){
	HX_STACK_PUSH("StringTools::ltrim","StringTools.hx",176);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(180)
...
::String StringTools_obj::rtrim( ::String s){
	HX_STACK_PUSH("StringTools::rtrim","StringTools.hx",201);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(205)
	int l = s.length;		HX_STACK_VAR(l,"l");
	HX_STACK_LINE(206)
...
::String StringTools_obj::trim( ::String s){
	HX_STACK_PUSH("StringTools::trim","StringTools.hx",223);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(223)
