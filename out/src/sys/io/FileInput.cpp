...
{
HX_STACK_PUSH("FileInput::new","sys/io/FileInput.hx",30);
{
	HX_STACK_LINE(30)
	this->__f = f;
}
...
bool FileInput_obj::eof( ){
	HX_STACK_PUSH("FileInput::eof","sys/io/FileInput.hx",70);
	HX_STACK_THIS(this);
	HX_STACK_LINE(70)
...
int FileInput_obj::readByte( ){
	HX_STACK_PUSH("FileInput::readByte","sys/io/FileInput.hx",34);
	HX_STACK_THIS(this);
	struct _Function_1_1{
		inline static int Block( ::sys::io::FileInput_obj *__this){
			HX_STACK_PUSH("*::closure","sys/io/FileInput.hx",35);
			{
				HX_STACK_LINE(35)
				try{
					HX_STACK_LINE(35)
