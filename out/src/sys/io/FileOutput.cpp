...
{
HX_STACK_PUSH("FileOutput::new","sys/io/FileOutput.hx",30);
{
	HX_STACK_LINE(30)
	this->__f = f;
}
...
{
		HX_STACK_PUSH("FileOutput::close","sys/io/FileOutput.hx",46);
		HX_STACK_THIS(this);
		HX_STACK_LINE(47)
		this->super::close();
		HX_STACK_LINE(48)
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
	HX_STACK_PUSH("FileOutput::writeBytes","sys/io/FileOutput.hx",38);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(p,"p");
	HX_STACK_ARG(l,"l");
	struct _Function_1_1{
		inline static int Block( ::sys::io::FileOutput_obj *__this,::haxe::io::Bytes &s,int &p,int &l){
			HX_STACK_PUSH("*::closure","sys/io/FileOutput.hx",39);
			{
				HX_STACK_LINE(39)
				try{
					HX_STACK_LINE(39)
...
{
		HX_STACK_PUSH("FileOutput::writeByte","sys/io/FileOutput.hx",34);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(34)
		try{
